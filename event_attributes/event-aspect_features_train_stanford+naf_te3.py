...
def main(argv=None):
    ...
    if len(argv) < 7:
        print('Usage: python3 event-aspect_features_train_stanford+naf_te3.py [stanford_folder] [naf_folder] [train_dir] predicateMatrix wordnet30_noun_supersenses outdir')
    else:
